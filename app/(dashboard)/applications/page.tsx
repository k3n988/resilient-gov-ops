import { ArrowRight, CheckCircle, Clock, FileText, Plus, Users } from "lucide-react"
        ...
        <div className="space-y-4">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500">Review submitted applications and monitor status across the process.</p>
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          <section className="rounded-[28px] border border-slate-200/70 bg-slate-50 p-5 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.16em] text-slate-500">Pending Approvals</p>
                <p className="mt-4 text-4xl font-semibold text-slate-950">24</p>
                <p className="mt-2 text-sm text-slate-500">Need action</p>
              </div>
          ...
          <section className="rounded-[28px] border border-slate-200/70 bg-emerald-50 p-5 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.16em] text-slate-500">Active Reviews</p>
                <p className="mt-4 text-4xl font-semibold text-slate-950">18</p>
                <p className="mt-2 text-sm text-slate-500">In progress</p>
              </div>
          ...
          <section className="rounded-[28px] border border-slate-200/70 bg-amber-50 p-5 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.16em] text-slate-500">Completed</p>
          ...
          <section className="rounded-[28px] border border-slate-200/70 bg-violet-50 p-5 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.16em] text-slate-500">Overdue</p>
        ...
        <section className="rounded-[28px] border border-slate-200/80 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500">Track application progress and approvals in one place.</p>
            </div>
            ...
            <table className="w-full min-w-[640px] text-sm">
              <thead>
                <tr className="border-b border-slate-200 text-left text-[11px] font-medium uppercase tracking-[0.24em] text-slate-500">
                  ...
                  <th className="py-3 pl-4 text-right">Submitted</th>
                </tr>
              </thead>
              <tbody className="text-sm text-slate-600">
                {[
                  ["Birth Certificate", "Civil Registration", "Pending", "Today"],
                  ["Death Certificate", "Vital Records", "Review", "Yesterday"],
                  ["Marriage License", "Civil Registration", "Approved", "Jul 29"],
                  ["CTC Request", "Document", "Completed", "Jul 28"],
                ].map(([name, type, status, date]) => (
                  <tr key={name} className="border-b border-slate-200/70 last:border-0">
                    <td className="py-4 pr-4 font-medium text-slate-950">{name}</td>
